    ...
    */
    ...
    export namespace neopixel {
        ...
        export class Strip {
            ...
            //% blockId="neopixel_set_strip_color" block="%strip|ColorShow %rgb=neopixel_colors"
            ...
            //% blockId=neopixel_show_bar_graph block="%strip|Show Bargraph of %value|up to %high"
            //% icon="\uf080"
            //% parts="neopixel"
